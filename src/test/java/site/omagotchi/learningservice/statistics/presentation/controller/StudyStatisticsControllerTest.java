...
class StudyStatisticsControllerTest {
    ...
    @Test
    @DisplayName("기간 추이 window 누락 예외")
    ...
    @Test
    @DisplayName("지원하지 않는 기간 추이 window 예외")
    ...
    @Test
    @DisplayName("수강생 통계 첫 페이지 정상 처리")
    ...
    @Test
    @DisplayName("수강생 통계 window 누락 예외")
    ...
    @DisplayName("수강생 통계 지원하지 않는 size 예외")
    ...
    @DisplayName("수강생 통계 지원하지 않는 sort 예외")
    ...
    @Test
    @DisplayName("수강생 7일 overview 정상 처리")
    ...
    @Test
    @DisplayName("overview 대상이 없으면 MEMBERSHIP_NOT_FOUND 반환")
    ...
    @Test
    @DisplayName("overview window 누락 예외")
    ...
    @Test
    @DisplayName("수강생 선택 집계일 date 누락 예외")
    ...
    @Test
    @DisplayName("수강생 선택 집계일 date 형식 오류 예외")
