...
public interface StudyRecordRepositoryCustom {
    ...
    Page<StudyRecordEntity> findActiveRecords(
            Long cohortMembershipId,
     ...
     *
     * <p>시간 구간은 {@code [startTime, endTime)} 반개구간으로 비교하므로
     * 기존 종료 시각과 요청 시작 시각이 같은 경우는 겹침이 아니다.</p>
     *
     * @param cohortMembershipId 기수 소속 식별자
    ...
    /**
     * 수정 대상 기록 자신을 제외하고 요청 구간과 겹치는 활성 기록이 있는지 확인한다.
     *
     * @param cohortMembershipId 기수 소속 식별자
     * @param excludedStudyRecordId 겹침 검사에서 제외할 공부 기록 식별자
     * @param startTime 요청 구간의 포함 시작 시각
     * @param endTime 요청 구간의 미포함 종료 시각
