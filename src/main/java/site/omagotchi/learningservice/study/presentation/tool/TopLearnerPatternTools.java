...
public class TopLearnerPatternTools implements AiToolProvider {
    ...
    @Tool(description = """
            ...
            "잘하는 사람들은 어떻게 공부해?", "상위권이랑 나랑 뭐가 달라?", "1등처럼 공부하고 싶어" 처럼
            다른 학습자와의 비교나 방향 제시가 필요할 때 사용하세요.
            ...
            ### 응답 해석 규칙
            - status가 "INSUFFICIENT_SAMPLE"이면: 기수 인원이 적어 익명성을 지키며 통계를 낼 수
              없는 것입니다. 개인정보 보호를 위해 제공할 수 없다고 안내하세요.
            ...
            - myPattern은 사용자 본인의 같은 기간 패턴입니다. top 값들과 비교해서
              가장 차이가 큰 한두 가지(시작 시각, 세션 길이, 학습일 수)를 짚어 방향을 제안하세요.
            - topFocusDensityPercent와 myPattern의 focusDensityPercent 비교가 가장 중요한
              축입니다. 총 시간이 비슷한데 밀도가 다르면, 시간을 늘리라고 하지 말고
              밀도 차이를 짚으세요.
